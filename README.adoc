...
. Repeat above steps until all recipe steps (_123, in count_) are printed.
. Check the solutions to see if there are other ways to solve.
(Remember, the solution may be less performant than yours)
. Rinse and repeat (_delete project and checkout again, then back to Step 1_) to build muscle memory.
...
1. Apache Maven 3.8.x or above. _Tested with Apache Maven 3.8.7_.
Link: https://maven.apache.org/download.cgi

1. JDK 11 or above. _Tested with OpenJDK 21 Early-Access Builds_.
Link: http://jdk.java.net/21/

1. Your favorite Java IDE. NOTE: _IntelliJ IDEA Ultimate was used to develop this kata_.
